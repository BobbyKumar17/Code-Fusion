...
const EditorPage = () => {
    ...
    const languageRef = useRef(null); // Correctly define languageRef
            ...
            socketRef.current.on('joined', ({ clients, username, socketId }) => {
                ...
                if (languageRef.current) {
                    socketRef.current.emit('sync-lang', {
                        lang: languageRef.current, // Use languageRef instead of langRef
                        socketId
                    });
                }
                if (inputRef.current) {
        ...
        <div className="mainWrap">
            ...
            <div className="editorWrap">
                <CodeEditor
                    ...
                    onLanguageChange={(language) => { languageRef.current = language }} // Update here
